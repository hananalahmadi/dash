...
The relative risk maps show a clear decrease in risk is observed, as the maps transition from red shades, indicating a high relative risk, to darker purple shades, representing a low relative risk. Notably, the Makkah region, located in the western part of the
